...
public class GameController : MonoBehaviour
{
    ...
    //Variabler som r�r DrillPowerUp
    private int maxDrill = 3; //maximalt antal anv�ndningar f�r DrillPowerup, skulle kunna s�ttas som SerializeField
    private int drillPowerUp;

    //Variabler som r�r RocketPowerUp
    private bool rocketPowerUpActive = false;
    private float rocketTimer = 0f;
    private float rocketMaxTime = 15f; //maxtid f�r raket, skulle kunna s�ttas som SerializeField
    private float reduceSpeedby = 0f;
    private float rocketSpeedFactor = 10f; //hur mycket snabbare farten tempor�rt �kar med RocketPowerUp, skulle kunna s�ttas som SerializeField
    private bool rocketSlowingDown = false;

    //Objekt som powerups p�verkar
    ...
    private int stars;
    private int health;
    //Variabler som p�verkar spelarens od�dlighet efter mottagen skada
